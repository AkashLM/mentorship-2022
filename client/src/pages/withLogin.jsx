      ...
      return (
        <>
          ...
          <Routes>
            ...
            <Route
              path="/latestmeetup"
              element={<LatestMeetup studentData={studentData} />}
            />
            <Route
              ...
              element={
                <Assignments
                  ...
                  setUploadSelector={setUploadSelector}
                />
              }
            />
            <Route
            ...
            <Route
              path="/groupdetails"
              element={<GroupDetails studentData={studentData} />}
            />
            <Route
              path="/quickmessage"
              element={<QuickMessage studentData={studentData} />}
            />
            <Route
            ...
            <Route
              path="/profilepage"
              element={<ProfilePage studentData={studentData} />}
            />
            <Route
              path="/previousmeetup"
      ...
      return (
        <>
          ...
          <Routes>
            ...
            <Route
              path="/message"
              element={<Message mentorData={mentorData} />}
            />
            <Route
            ...
            <Route
              path="/approvalnotes"
              element={<ApprovalNotes typeOfUser={typeOfUser} />}
            />
            <Route
              path="/studentnotes"
              element={
